                ...
                <div class="address-form">
                  <div class="module-form-row">
                    <div class="form-item-v3">
                      <input placeholder="姓名" type="text" class="js-verify" v-model="receiveInfo.name">
                      <div class="verify-error"></div>
                    </div>
                  </div>
                  <div class="module-form-row">
                    <div class="form-item-v3" :class="{'form-invalid-item':phoneError}">
                      <input placeholder="手机号" type="text" class="js-verify" v-model="receiveInfo.phone"
                             @blur="inspectPhone" @focus="setPhone">
                  ...
                  <div class="module-form-row clear">
                    <div class="form-item-v3 area-code-w fn-left form-valid-item">
                      <input placeholder="区号" type="text" class="js-verify js-address-area-code"
                             v-model="receiveInfo.areaCode">
                      <div class="verify-error"></div>
                    </div>
                    <div class="form-item-v3 telephone-w fn-right form-valid-item">
                      <input placeholder="固定电话" type="text" class="js-verify js-address-telephone"
                             v-model="receiveInfo.landLine">
                      <div class="verify-error"></div>
                    </div>
                  </div>
                  <div class="module-form-row clear">
                    <div class="form-item-v3 select-item province-wrapper">
                      <select name="province_code" class="province select-province js-form-province js-verify"
                              v-model="receiveInfo.provinceId">
                  ...
                  <div class="module-form-row clear">
                    <div class="form-item-v3 select-item city-wrapper fn-left form-focus-item">
                      <select class="city select-city js-form-city js-verify" v-model="receiveInfo.cityId">
                    ...
                    <div class="form-item-v3 select-item district-wrapper fn-right form-focus-item">
                      <select class="city select-city js-form-city js-verify" v-model="receiveInfo.countyId">
                  ...
                  <div class="module-form-row">
                    <div class="form-item-v3">
                      <input placeholder="详细地址" type="text" class="js-verify" v-model="receiveInfo.add">
                      <div class="verify-error"></div>
                    </div>
                  </div>
                  <div class="module-form-row fn-clear">
                    <input type="checkbox" class="hide">
                    <span class="blue-checkbox" :class="{'blue-checkbox-on':receiveInfo.default}"
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      submitInfo () {
        if (this.isRight) {
          this.$store.commit('submitInfo', this.receiveInfo)
        }
      }
    },
    watch: {
