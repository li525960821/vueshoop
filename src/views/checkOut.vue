          ...
          <div class="box-inner js-checkout-address-panel ">
            <div class="address-common-table js-multiple-address-panel">
              <ul class="address-item-list clear js-address-item-list">
                <li class="js-choose-address" @click="chooseReceive(index)"
          ...
          <div class="invoice-detail"> 发票抬头：
            <div class="radio-box">
              <label>
                ...
                <span class="blue-radio" @click="checkedInvoice(true)"
                      :class="{'blue-radio-on':incoice.prosonal}"><a></a></span> 个人
              </label>
              <label>
                <input type="radio" class="hide">
                <span class="blue-radio" @click="checkedInvoice(false)"
                      :class="{'blue-radio-on':!incoice.prosonal}"><a></a></span> 单位
              </label>
            </div>
            <div class="module-form-row form-item fn-hide js-invoice-title" v-if="!incoice.prosonal">
              <div class="module-form-item-wrapper no-icon small-item">
                <i v-if="!incoice.name">请填写公司发票抬头</i>
                <input type="text" class="js-verify" v-model="incoice.name">
                <div v-if="!incoice.name" class="verify-error">必填</div>
              </div>
            </div>
          </div>
      ...
      <div class="gray-box">
        ...
        <div class="box-inner">
          <div class="last-payment clear">
            <span class="jianguo-blue-main-btn
             big-main-btn
             payment-blue-bt
             fn-right js-checkout"
                  @click="submitOrder"><a>提交订单</a></span>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      submitOrder () {
        // 判断是否为公司
        if (!this.incoice.prosonal && !this.incoice.name) {
          return
        }
