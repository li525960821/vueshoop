      ...
      <div class="item-box">
        <div class="gallery-wrapper">
          <div class="gallery">
            <div class="thumbnail">
              <ul>
                <li :class="{'on':index==itemIndex}" @click="tableImg(index)" :key="index"
                    v-for="(img,index) in itemInfo.ali_images" :title="index">
                  <img :src="img+'?x-oss-process=image/resize,w_54/quality,Q_90/format,webp'"></li>
              </ul>
            </div>
            <div class="thumb">
              <ul>
                <li :class="{'on':index==itemIndex}" :key="index" v-for="(img,index) in itemInfo.ali_images">
