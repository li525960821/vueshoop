      ...
      <div class="cart-box">
                ...
                <div class="cart-top-items" v-for="(item,index) in carPanelData">
                  <div class="cart-items">
                    <div class="items-choose">
                      <span class="blue-checkbox-new" :class="{'checkbox-on':item.check}"
                            @click="checkGoods(item.sku_id)"><a></a></span>
                    </div>
                    ...
                    <div class="item-cols-num">
                      <div class="select js-select-quantity">
                        <span class="down" :class="{'down-disabled':item.count<= 1}"
                              @click="subCarPanelData(item.sku_id)">-</span>
                        <span class="num">
														{{item.count}}
													</span>
                        <span class="up" :class="{'up-disabled':item.count >= item.limit_num}"
                              @click="plusCarPanelData(item.sku_id)">+</span>
        ...
        <div class="cart-bottom-bg fix-bottom" v-if="count > 0">
          ...
          <div class="shipping">
            ...
            <span class="jianguo-blue-main-btn big-main-btn js-checkout" :class="{'disabled-btn':checkedCount<1}">
